...
Versão atual: **v1.1.4** (`versionCode 10104`).
...
- histórico local dos cinco exercícios mais recentes, sem rótulos redundantes e com botão compacto vermelho de limpeza;
