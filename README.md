...
Versão atual: **v1.1.3** (`versionCode 10103`).
...
- histórico local dos cinco exercícios mais recentes, sem rótulos redundantes e com botão de limpeza em largura total;
